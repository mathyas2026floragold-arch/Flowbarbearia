...
2. Na Northflank, redirecione tráfego para a imagem anterior imutável.
...
Migrations devem ser aditivas e compatíveis com a versão anterior. Prefira uma migration corretiva. Antes de qualquer reversão destrutiva, tire snapshot e confirme PITR. `003_rollback.sql` remove todo o domínio e serve apenas para ambientes descartáveis; não deve ser executado em produção com dados.
